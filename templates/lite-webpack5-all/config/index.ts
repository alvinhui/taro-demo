...
type MixedCompilerConfig = IProjectConfig<'webpack5'> & {
  harmony: NonNullable<IProjectConfig<'webpack5'>['harmony']> & {
    compiler: 'vite'
  }
}
...
export default defineConfig<'webpack5'>(async (merge) => {
  const baseConfig: MixedCompilerConfig = {
    projectName: 'lite-webpack5-all',
    date: '2026-8-31',
    designWidth: 750,
    deviceRatio: {
      640: 2.34 / 2,
